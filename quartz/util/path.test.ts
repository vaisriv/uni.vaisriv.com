...
describe("transforms", () => {
    function asserts<Inp, Out>(
        ...
        for (const [inp, expected] of pairs) {
            ...
            assert(
                checkPost(actual),
                `${actual} wasn't the expected output type`,
            );
        }
    }
    ...
    test("transformInternalLink", () => {
        asserts(
            [
                ...
                [
                    "content/with spaces#and Anchor!",
                    "./content/with-spaces#and-anchor",
                ],
            ],
...
describe("link strategies", () => {
    ...
    describe("absolute", () => {
        ...
        test("from a/b/c", () => {
            ...
            assert.strictEqual(
                path.transformLink(cur, "a/b/d", opts),
                "../../a/b/d",
            );
            assert.strictEqual(
            ...
            assert.strictEqual(
                path.transformLink(cur, "e/f", opts),
                "../../e/f",
            );
            assert.strictEqual(
        ...
        test("from a/b/index", () => {
            ...
            assert.strictEqual(
                path.transformLink(cur, "a/b", opts),
                "../../a/b",
            );
            assert.strictEqual(
                path.transformLink(cur, "index", opts),
        ...
        test("from index", () => {
            ...
            assert.strictEqual(
                path.transformLink(cur, "a/b/c", opts),
                "./a/b/c",
            );
            assert.strictEqual(
                path.transformLink(cur, "a/b/index", opts),
    ...
    describe("shortest", () => {
        ...
        test("from a/b/c", () => {
            const cur = "a/b/c" as FullSlug;
            assert.strictEqual(
                path.transformLink(cur, "d", opts),
                "../../a/b/d",
            );
            assert.strictEqual(
                path.transformLink(cur, "h", opts),
                "../../e/g/h",
            );
            assert.strictEqual(
                path.transformLink(cur, "a/b/index", opts),
