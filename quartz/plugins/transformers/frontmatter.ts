                ...
                () => {
                    return (_, file) => {
                        ...
                        if (
                            ...
                            data.title =
                                file.stem ??
                                i18n(cfg.configuration.locale).propertyDefaults
                                    .title;
                        }

                        const tags = coerceToArray(
                            coalesceAliases(data, ["tags", "tag"]),
                        );
                        if (tags)
                            data.tags = [
                                ...new Set(
                                    tags.map((tag: string) => slugTag(tag)),
                                ),
                            ];
                        ...
                        if (
                            ...
                            data.permalink =
                                data.permalink.toString() as FullSlug;
                        ...
                        const created = coalesceAliases(data, [
                            "created",
                            "date",
                        ]);
                        if (created) {
                        ...
                        file.data.frontmatter =
                            data as QuartzPluginData["frontmatter"];
                    };
                },
            ];
        },
